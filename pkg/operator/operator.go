/*
SPDX-FileCopyrightText: 2026 SAP SE or an SAP affiliate company and cf-service-operator-cop contributors
...
import (
	...
	"github.com/sap/cf-service-operator-cop/internal/transformer"
)

const Name = "cf-service-operator-cop.cs.sap.com"
...
func (o *Operator) Setup(mgr ctrl.Manager) error {
	...
	if err := component.NewReconciler[*operatorv1alpha1.CFServiceOperator](
		o.options.Name,
		resourceGenerator,
