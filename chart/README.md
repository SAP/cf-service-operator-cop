# cf-service-operator-cop

![Version: 0.2.32](https://img.shields.io/badge/Version-0.2.32-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.2.32](https://img.shields.io/badge/AppVersion-v0.2.32-informational?style=flat-square)

A Helm chart for https://github.com/sap/cf-service-operator-cop
...
| image.repository | string | `"ghcr.io/sap/cf-service-operator-cop"` | Image repository |
